        ...
        <div class="footer-inner">
            ...
            <div class="bg-info">
                ...
                <div class="footer-bgname">
                    ...
                    Background
                    <a :href="props.url" target="_blank" rel="noreferrer" class="bg-name" :class="{ 'bg-link': props.url }" data-pointer>
...
.footer .footer-inner .bg-info, .footer .footer-inner .bg-info .footer-bgname {
    display: flex;
}
